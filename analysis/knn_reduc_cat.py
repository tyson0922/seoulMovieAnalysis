...
joblib.dump(knn, os.path.join(models_dir, "knn_model_reduced.pkl"))
...
results_path = os.path.join(results_dir, "knn_model_reduced.txt")
with open(results_path, "w", encoding="utf-8") as f:
    f.write("📄 knn_reduc_cat Results\n")
    f.write("=" * 30 + "\n")
